<template>
  <div id="candidate">
    <div class="pop">
              ...
              <template v-if="isHasAuth">
                <div class="download" v-loading="loadingshow">
                  ...
                  <div class="pdf">
                    ...
                    <div class="pdf-r" @click="onloadfile('pdf')"><a style="color:#00C4CD">下载</a></div>
                  </div>
                  <div class="pdf">
                    <div class="pdf_l">
                    ...
                    <div class="pdf-r" @click="onloadfile('doc')"><a style="color:#00C4CD">下载</a></div>
                  </div>
                </div>
      ...
      <login-pop :show-close="false"  v-else ref="loginPop" />
    </div>
