...
<el-dialog
  width="612px"
  :modal="false"
  custom-class="app-dialog dynamic-resume-dialog"
  @close="handleClose"
  :visible.sync="dialogStatus"
  title="转发简历">
  <div class="warpper-scroll content">
    <div class="title"></div>
    <div class="scroll-c">
    <div class="con-l">
...
<script>
import { generateUrl, gethistoryUrl, emailtoforword } from 'API/candidateType'
const debounce = (() => {
  let timer = 0
  return (callback, ms) => {
    clearTimeout(timer)
...
export default {
  ...
  methods: {
    ...
    send () {
      ...
      emailtoforword(this.form).then(({ data }) => {
...
<style lang="scss">
.app-dialog.dynamic-resume-dialog {
