    ...
    <div class="main-center">
      <div class="lists-wrapper" v-loading="getLoading">
        <template v-if="currentType === 'position'">
          <no-found v-if="!getLoading && !listData.length" tip-text="没有符合筛选条件的职位，放宽筛选条件试试？" :max-width="332"></no-found>
        ...
        <template v-else>
          <no-found v-if="!getLoading && !companyListData.length" tip-text="没有符合筛选条件的公司，放宽筛选条件试试？" :max-width="332"></no-found>
          <div class="position-lists" v-else>
